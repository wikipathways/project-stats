...
def convert_version_to_numeric_tuple(version):
    """
    Converts version string into a tuple of numbers
...
def compare_versions(item1, item2):
    """
    Compares versions which are passed
    in as str objects
...
def add_days_as_primary_release(release_dict=None, version_list=None):
    """
    Iterates through the versions and calculates the days a given
    ...
    :param release_dict:
    :type release_dict: dict
    :param version_list: ordered list of versions
